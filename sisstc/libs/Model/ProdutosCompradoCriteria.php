...
require_once("DAO/ProdutosCompradoCriteriaDAO.php");

/**
 * The ProdutosCompradoCriteria class extends ProdutosCompradoDAOCriteria and is used
 ...
 * @version 1.0
 */
class ProdutosCompradoCriteria extends ProdutosCompradoCriteriaDAO
{
