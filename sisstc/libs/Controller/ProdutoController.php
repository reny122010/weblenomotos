...
class ProdutoController extends AppBaseController
{
	...
	public function Query()
	{
		try
		{
			...
			if ($filter) $criteria->AddFilter(
				new CriteriaFilter('Idproduto,Codigodebarras,Nome,Preco,Custo,Quantidade,Unidade'
				, '%'.$filter.'%')
			);
	...
	public function Read()
	{
		try
		{
			$pk = $this->GetRouter()->GetUrlParam('idproduto');
	...
	public function Create()
	{
		try
		{
			...
			// $produto->Idproduto = $this->SafeGetVal($json, 'idproduto');

			$produto->Codigodebarras = $this->SafeGetVal($json, 'codigodebarras');
			$produto->Nome = $this->SafeGetVal($json, 'nome');
			$produto->Preco = $this->SafeGetVal($json, 'preco');
			$produto->Custo = $this->SafeGetVal($json, 'custo');
			$produto->Quantidade = $this->SafeGetVal($json, 'quantidade');
			$produto->Unidade = $this->SafeGetVal($json, 'unidade');
	...
	public function Update()
	{
		try
		{
			...
			// $produto->Idproduto = $this->SafeGetVal($json, 'idproduto', $produto->Idproduto);

			$produto->Codigodebarras = $this->SafeGetVal($json, 'codigodebarras', $produto->Codigodebarras);
			$produto->Nome = $this->SafeGetVal($json, 'nome', $produto->Nome);
			$produto->Preco = $this->SafeGetVal($json, 'preco', $produto->Preco);
			$produto->Custo = $this->SafeGetVal($json, 'custo', $produto->Custo);
			$produto->Quantidade = $this->SafeGetVal($json, 'quantidade', $produto->Quantidade);
			$produto->Unidade = $this->SafeGetVal($json, 'unidade', $produto->Unidade);
