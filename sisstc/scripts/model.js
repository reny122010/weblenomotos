/**
 * backbone model definitions for SISSTC
 */
...
/**
 * Compra Backbone Model
 */
model.CompraModel = Backbone.Model.extend({
	urlRoot: 'api/compra',
	idAttribute: 'idcompra',
	idcompra: '',
	cpfcliente: '',
	valor: '',
	data: '',
...
/**
 * Compra Backbone Collection
 */
model.CompraCollection = model.AbstractCollection.extend({
	url: 'api/compras',
...
/**
 * ProdutosComprado Backbone Model
 */
model.ProdutosCompradoModel = Backbone.Model.extend({
	urlRoot: 'api/produtoscomprado',
	idAttribute: 'idcompra',
	idcompra: '',
	idproduto: '',
	quantidade: '',
...
/**
 * ProdutosComprado Backbone Collection
 */
model.ProdutosCompradoCollection = model.AbstractCollection.extend({
	url: 'api/produtoscomprados',
	model: model.ProdutosCompradoModel
});
